                ...
                <div class="agileinfo-ads-display col-md-12 w3l-rightpro">
                    <div class="wrapper">
                        ...
                        <div class="product-sec1">
                            <%
                                ResultSet rs = DBLoader.executequery("select * from products ORDER BY RAND() LIMIT 15");
                                while (rs.next()) {
                                        ...
                                        <div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
                                            <form action="#" method="post">
                                                <fieldset>
                                                    ...
                                                    <input type="button" name="submit" onclick="gotoproductdetails('<%=pid%>','<%=categoryname%>')" value="View Details" class="button" />
                                                    <br>
                                                    <br>
                                                    <br>
                                                </fieldset>
